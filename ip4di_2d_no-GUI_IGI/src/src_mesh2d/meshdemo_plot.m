...
%% REDUCTION FATOR FOR LAKE SUPERIOR
...
axis equal off;
title('Simple mesh in a circle')


%answer = input
fprintf(['The element size function is generated automatically to try to adequately resolve the geometry. \n'    ...
                '\n'                                                                                                    ...
...
patch('faces',t,'vertices',p,'facecolor','none','edgecolor','b');
axis equal off;
title('Another mesh in a circle')
...
%answer = input
disp(['It is often necessary to specify the element size in some locations and the following example \n' ...
...
patch('faces',t,'vertices',p,'facecolor','none','edgecolor','b');
axis equal off;
title('Very fine "sliver" geometry')
...
patch('faces',t,'vertices',p,'facecolor','none','edgecolor','b');
axis equal off;
title('Simulate flow past a cylinder (combine automatic and user size functions)')
...
node  = [p1; p2; p3; p4; p5; p6; p7] * reduction_factor;
cnect = [
        c1
        c2+n1
        c3+n2+n1
...
patch('faces',t,'vertices',p,'facecolor','none','edgecolor','b');
axis equal off;
title('Lake Superior (auto sizing)')
...
patch('faces',t,'vertices',p,'facecolor','none','edgecolor','b');
axis equal off;
title('Gradient limiting the size function')
