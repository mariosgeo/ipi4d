...
%     tmp_d.data(tpar,:)=0;
 ...
 end   %end if input.bgr_res_flag~=0
 ...
 % update prop.
 % FL /!\ background (outside of model) does not seem to be updated.
 %        This may lead to spurious reflections on the
 %        edges of the model in case of strong contrasts.
 for i=1:mesh.num_param
     ind= mesh.icon(4,:)==i;
