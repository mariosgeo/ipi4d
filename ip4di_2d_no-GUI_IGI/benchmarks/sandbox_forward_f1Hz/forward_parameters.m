...
input.file_mesh_out=['mesh_sandbox_inversion_26-layers_1-cell-per-elec-spacing_pml-0.5m.mat'];
...
input.file_model_in=['data/model_sandbox_true_f1Hz_251x601_h0.002.dat'];
...
input.file_model_out=['model_sandbox_true_f1Hz_interp-on-mesh-inv_26layers_1cpe.dat'];
