function [mesh,fem]=kim_inversion2(input,mesh,fem)
...
fem.resolution_matrix=(fem.A.'*input.Wd*fem.A + 1e-4*eye(inmput.num_files*mesh.num_param))\(fem.A.'*input.Wd*fem.A );
