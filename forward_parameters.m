...
input.file_model_in=['demodata/model_sandbox_init_251x601_h0.002.dat'];
...
input.file_model_out=['model_interp-on-mesh-fwd.dat'];
...
input.mes_in='demodata/data_sandbox.dat';
% file acqui_out is written if read_acqui==0
input.file_acqui_out='forward_sandbox_acqui_DP-DP.dat';

% input.file_data_out will contain the calculated synthetic data
input.file_data_out=['forward_sandbox_data-init.dat'];
